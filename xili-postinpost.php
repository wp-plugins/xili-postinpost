...
/*
 * 2011-06-06 - 0.9.7 - source code cleaned, support email improved
...
class xili_postinpost {
	...
	function on_sidebox_mail_content ( $data ) {
		...
		<label for="themeenable">
			<input type="checkbox" id="themeenable" name="themeenable" value="enable" <?php if( $this->xili_settings['theme']=='enable') echo 'checked="checked"' ?> />&nbsp;<?php printf(__("Theme name: %s", "xili_postinpost"),get_option ('stylesheet') ) ; ?>
		</label><br />
		<?php if (''!= WPLANG ) {?>
