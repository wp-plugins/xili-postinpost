...
?>
		...
		<?php if ( $xili_postinpost->xili_settings['displayperiod'] ) { ?>
		...
		<?php } else { ?>
		<input type="hidden" id="<?php echo $this->get_field_id('todate'); ?>" name="<?php echo $this->get_field_name('todate'); ?>" type="text" value="<?php echo $todate; ?>" size="20" />
		<input type="hidden" id="<?php echo $this->get_field_id('fromdate'); ?>" name="<?php echo $this->get_field_name('fromdate'); ?>" type="text" value="<?php echo $fromdate; ?>" size="20" />
		<?php } ?>
